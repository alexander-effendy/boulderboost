...
import BoulderingDark from '@/assets/BoulderingDark.jpeg';
  ...
  return (
    <>
      ...
      <div className="absolute inset-0 bg-cover bg-center"
        style={{
          backgroundImage: `url(${BoulderingDark})`,
          opacity: 0.25
        }}
      />
      <div 
        className="overflow-hidden h-screen items-center justify-center grid bg-black text-white">
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
            {/* Title */}
            <div className="text-center">
              <p className="text-xs font-semibold text-slate-400 tracking-wide uppercase mb-3">
                Get Stronger: Your Future Is Always To Go Up
              </p>
              <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
                BoulderBoost: Climbing & Workouts
              </h1>
            </div>
            {/* End Title */}
            {/* Avatar Group */}
            ...
            <Button 
              className="w-full rounded-[7px] border-slate-200 hover:font-bold border-[0.9px] hover:bg-black" 
              variant={"outline"}
