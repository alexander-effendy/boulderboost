...
export default function HeroFormSignUpForm() {
  return (
    <>
      {/* Hero */}
      <div className="bg-[#18181b] text-white relative bg-gradient-to-bl from-primary-foreground via-primary-foreground to-background">
        <div className="container py-24 sm:py-32">
          {/* Grid */}
          <div className="grid items-center md:grid-cols-2 gap-8 lg:gap-12">
            <div>
              <p className="inline-block text-sm font-medium bg-clip-text bg-gradient-to-l from-blue-600 to-violet-500 text-transparent dark:from-blue-400 dark:to-violet-400">
                A vision to climb V10
              </p>
              {/* Title */}
              <div className="mt-4 md:mb-12 max-w-2xl">
                <h1 className="mb-4 scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
                  Get Stronger: Your future is to go up
                </h1>
                <p className="text-xl text-slate-500 text-muted-foreground">
                  Train your muscle and say good bye to fatigue.
                </p>
              </div>
              {/* End Title */}
              {/* Blockquote */}
              <blockquote className="hidden md:block relative max-w-sm">
                <svg
                  className="absolute top-0 start-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-[#28292b]"
                  width={16}
                  height={16}
                  viewBox="0 0 16 16"
                  fill="none"
                ...
                <div className="relative z-10">
                  <p className="text-xl text-slate-300 italic">
                    Just go up. Just don't fall. Just jump.
                  </p>
                </div>
                <footer className="mt-3">
                  <div className="flex items-center">
                    ...
                    <div className="grow ms-4">
                      <div className="font-semibold">Alexander Effendy</div>
                      <div className="text-xs text-muted-foreground">
                        Software Developer | BoulderBoost
                      </div>
                    </div>
                  </div>
                </footer>
            ...
            <div>
              ...
              <form>
                <div className="lg:max-w-lg lg:mx-auto lg:me-0 ms-auto">
                  {/* Card */}
                  <Card className="rounded-[10px] bg-black border-slate-700 border-[0.9px]">
                    <CardHeader className="text-center">
                      ...
                      <CardDescription className="text-slate-400">
                        ...
                        <a
                          className="hover:underline underline-offset-4 text-slate-200"
                          href="#"
                        >
                          Sign in here
                        </a>
                    ...
                    <CardContent>
                      <Button className="w-full rounded-[7px] border-slate-700 border-[0.9px]" variant={"outline"}>
                        <svg
                      ...
                      <div className="mt-5">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <Button className="mt-3 col-span-2 bg-white text-black rounded-[7px]">
                            Get started
                          </Button>
                        </div>
                        {/* Grid End */}
